...
const SearchHeader=()=>{
    ...
    return(
      <div className="">
        <input className="p-2 m-2 w-80 border border-gray-200 rounded-r-lg bg-gray-100" placeholder="🔍 Search" />
      </div>
...
const Logo =()=>{
    ...
    return (
        <div className="">
            <img alt="linkedin" className="h-14 "
...
const Header=()=>{
    ...
    return(
        <header className=" bg-white border-t grid grid-flow-col w-full p-1 shadow-md sticky top-0 " >
            <Logo/>
            <SearchHeader/>
            <HeaderNavList/>
        </header>
